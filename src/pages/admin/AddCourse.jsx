  ...
  return (
    <div className="add_course_container">
      <form className="form_add_course">
        ...
        <Button
          onClick={() =>
            !courseName ? toast.error("กรุณากรอกชื่อคอร์ส") : setPopUp1(!popUp1)
          }
          name="ยืนยัน"
          type="ok"
          typeButton="button"
                  ...
                  <div>
                    ...
                    {Math.round(
                      allOverHours.hours * 60 -
                        parseInt(allOverHours.hours) * 60
                    )}{" "}
                    นาที
                  </div>
